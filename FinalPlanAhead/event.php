...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="home.php"><div ><img src="logo.PNG" style="position:absolute;top:10px;height:75%;width:4%;"/>   
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><form method="post">
                    <button name="logout" style="position:relative;left:1440;top:10px;" class="btn btn-danger my-2">Logout</button>
            </form></li>
      </ul>
    </div>
  </div>
